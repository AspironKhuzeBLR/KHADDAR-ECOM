                    ...
                    >
                      <div style={{
                        ...
                        <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'flex-end' }}>
                          ...
                          {/* Show cancellation request submitted message */}
                          {isCancellationRequested(order) && orderStatus !== 'cancelled' && (
                            <div style={{
                              padding: '8px 16px',
                              fontSize: '0.75rem',
                              fontFamily: 'Inter, sans-serif',
                          ...
                          {canCancelOrder(orderDate) && orderStatus !== 'cancelled' && !isCancellationRequested(order) && (
                            <button
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                <strong>Order #:</strong> {selectedOrder?.order_number || selectedOrder?.order_id || selectedOrder?.id}
              </p>
              <p style={{
                fontSize: '0.875rem',
                color: '#4C2E2E'
              }}>
                <strong>Total:</strong> {formatPrice(selectedOrder?.total_amount || selectedOrder?.total)}
              </p>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ marginBottom: '12px' }}>
                  <strong>Cancellation Window:</strong> Orders can be cancelled within 24 hours of placing the order, provided the item has not been shipped.
                </p>
                <p style={{ marginBottom: '12px' }}>
                  <strong>Post-Dispatch:</strong> Once dispatched, cancellations cannot be accepted.
                </p>
                <p style={{ marginBottom: '12px' }}>
                  <strong>Refund Processing:</strong> Prepaid cancellation refunds will be processed to the original payment method within 5–7 working days.
                </p>
                <p style={{ marginBottom: '12px' }}>
                  <strong>COD Orders:</strong> No charges will be applied for cancelled COD orders.
                </p>
                <p style={{ marginBottom: '0' }}>
                  <strong>Important:</strong> Khaddar does not offer refunds for general returns, as our collections are produced in limited quantities. Refunds are only applicable if the product delivered is damaged or incorrect.
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              >
                I have read and agree to Khaddar's <Link to="/cancellation-policy" target="_blank" style={{ color: '#6F3132', textDecoration: 'underline' }}>Cancellation Policy</Link> and <Link to="/refund-policy" target="_blank" style={{ color: '#6F3132', textDecoration: 'underline' }}>Refund Policy</Link>. I understand that this order can only be cancelled within 24 hours if not yet dispatched, and refunds (if applicable) will be processed within 5-7 working days.
              </label>
            </div>
            ...
            <div style={{
              ...
              <button
                ...
                disabled={!agreedToPolicy || !cancelReason.trim() || cancelLoading}
                style={{
                  padding: '12px 24px',
                  fontSize: '0.875rem',
                  fontFamily: 'Inter, sans-serif',
                  ...
                  textTransform: 'uppercase',
                  letterSpacing: '0.05em',
                  backgroundColor: agreedToPolicy && cancelReason.trim() && !cancelLoading ? '#d32f2f' : '#ccc',
                  color: '#fff',
                  border: 'none',
                  borderRadius: '4px',
                  cursor: agreedToPolicy && cancelReason.trim() && !cancelLoading ? 'pointer' : 'not-allowed',
                  transition: 'all 0.3s ease',
                  opacity: agreedToPolicy && cancelReason.trim() && !cancelLoading ? 1 : 0.6
                }}
                onMouseOver={(e) => {
