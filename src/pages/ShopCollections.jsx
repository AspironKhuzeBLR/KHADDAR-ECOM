  ...
  useEffect(() => {
    const loadCategories = async () => {
      try {
        ...
        // Filter out main parent categories if you only want sub-categories, 
        // or keep all. Here we filter for sub-categories only to keep the list clean.
        const allSubCategories = categoriesArray.filter(cat => 
          cat.type === 'sub' || (cat.parent_id !== null && cat.parent_id !== 0)
        );
      ...
      <div className="shop-products">
        <div className="container">
          {selectedCategoryData ? (
            ...
            <h2 className="products-category-title">Complete Collection</h2>
          )}
